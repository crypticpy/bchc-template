...
100 entries at 9.7 seconds, 523 files/19.6 MiB, 59.6 KiB catalog HTML gzip, 8,894 DOM nodes, 24.3
KiB CSS gzip, 39.9 KiB JavaScript gzip, 147.4 KiB fonts, 1.26 MiB images, 16.6 KiB search gzip, and
20.1 KiB comparison data gzip. Chrome 151 under the low-end-mobile profile measured 844.4 ms cold
search initialization, 169.6 ms warm-search p95, 26.1 ms filter p95 across rare/mid/common visible
facets, 56.0 ms sort p95, and 1.9 ms comparison p95. The exact-toolchain macOS confirmation measured
93.3 ms search p95 and 15.9 ms filter p95. The runs used Node 22.22.2, npm 10.9.4, Ruby 3.3.11, and
Bundler 4.0.11.

The representative 500-entry target built successfully in 44.6 seconds with an 82.2 KiB search
payload, but its catalog page reached 151.1 KiB gzip and 36,860 DOM nodes. The 1,000-entry stress
case built in 111.6 seconds and produced a 102.4 MiB artifact plus a 257.9 KiB/71,819-node catalog
